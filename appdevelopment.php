...
<section class="page-wrapper edutim-course-single course-single-style-3">
    ...
    <p>Mobile application development is the process of creating software applications that run on a mobile device, and a typical mobile application utilizes a network connection to work with remote computing resources.</p>
        <p> Hence, the mobile development process involves creating installable software bundles (code, binaries, assets, etc.) , implementing backend services such as data access with an API, and testing the application on target devices.</p>
            ...
            <div class="course-widget course-info">
                ...
                <div class="instructor-profile">
                    ...
                    <div class="profile-info">
                        ...
                        <p>I Vedant Naidu working as a developer When we were choosing the right development approach for their projects, developers consider the desired user experience, the computing resources and native features required by the app.</p>
                        <div class="instructor-courses">
                            <span><i class="bi bi-folder"></i>8 Courses</span>
                            <span><i class="bi bi-group"></i>40 Students</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="course-review-wrapper">
                    <div class="course-review">
                        ...
                        <div class="review-text">
                            ...
                            <p>Great course. Well structured, paced and I feel far more confident using this software now then I did back when I was learning.</p>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="course-sidebar">
                    <div class="course-single-thumb">
                        <img src="assets/images/course/ad.png" alt="" class="img-fluid w-100">

                        <div class="course-price-wrapper">
                            <div class="course-price"><h4>Price: <span>6999/-</span> <del class="text-muted">9999/-</del></h4></div>
                            <p class="text-info"><i class="fa fa-clock mr-2"></i>Only few days left at this price</p>
                    ...
                    <div class="course-widget course-details-info">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="">
                                    ...
                                    <a href="#" class="d-inline-block">Vedant Naidu</a>
                                </div>
                            </li>
                        ...
                        <div class="course-widget course-share d-flex justify-content-between align-items-center">
                            ...
                            <ul class="social-share list-inline">
                                <li class="list-inline-item"><a href="https://www.facebook.com/tectigniunniversity/"><i class="fab fa-facebook"></i></a></li>
                                <li  class="list-inline-item"><a href="https://www.instagram.com/tectignisuniversity/"><i class="fab fa-instagram"></i></a></li>
        ...
        <div class="col-lg-4 col-md-6">
                <div class="course-block">
                    <div class="course-img">
                        <img src="assets/images/course/dmarketing.jpg" alt="" class="img-fluid">
                        <span class="course-label">Begineer</span>
                    </div>
                    
                    <div class="course-content">
                            <div class="course-price ">6999/-</div>   
                            
                            <h4><a href="digitalmarketing.php">Media Course for Digital Marketing</a></h4>    
                            <div class="rating">
                                <a href="#"><i class="fa fa-star"></i></a>
                                <a href="#"><i class="fa fa-star"></i></a>
                                <a href="#"><i class="fa fa-star"></i></a>
                            ...
                            <p>Digital marketing refers to advertising delivered through like search engines, websites, 
                                social media, email & mobile apps. Using these online media channels, digital marketing services, and brands.</p>
                            ...
                            <div class="course-footer d-lg-flex align-items-center justify-content-between">
                                ...
                                <div class="buy-btn"><a href="digitalmarketing.php" class="btn btn-main-2 btn-small">Details</a></div>
                            </div>
                        </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="course-block">
                    <div class="course-img">
                        <img src="assets/images/course/graphicd.jpg" alt="" class="img-fluid">
                        <span class="course-label">Begineer / Advanced</span>
                    </div>
                    
                    <div class="course-content">
                            <div class="course-price ">6999/-<span class="del"></span></div>   
                            
                            <h4><a href="graphicdesigning.php">Designing Crash Course for Graphic Designer</a></h4>    
                            <div class="rating">
                                <a href="#"><i class="fa fa-star"></i></a>
                                <a href="#"><i class="fa fa-star"></i></a>
                                <a href="#"><i class="fa fa-star"></i></a>
                            ...
                            <div class="course-footer d-lg-flex align-items-center justify-content-between">
                                ...
                                <div class="buy-btn"><a href="graphicdesigning.php" class="btn btn-main-2 btn-small">Details</a></div>
                            </div>
                        </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="course-block">
                    <div class="course-img">
                        <img src="assets/images/course/web.jpg" alt="" class="img-fluid">
                        <span class="course-label">Begineer</span>
                    </div>
                    ...
                    <div class="course-content">
                            ...
                            <h4><a href="webdevelopment.php">Websites Developing Course web Development</a></h4>    
                            <div class="rating">
                                <a href="#"><i class="fa fa-star"></i></a>
                                <a href="#"><i class="fa fa-star"></i></a>
                                <a href="#"><i class="fa fa-star"></i></a>
                            ...
                            <p>Web development is the work involved in developing a website for the Internet.
                                 and can range from developing a simple single static page of plain text to complex web applications, electronic businesses, 
