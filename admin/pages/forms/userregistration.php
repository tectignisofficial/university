...
if(isset($_POST['sub']))
    ...
    $sql="INSERT INTO `user`(`name`, `email`, `mobile_no`, `password`,`upload_icon`,`id`) VALUES ('$name','$email','$mobile_no','$password','$upload_icon','$id')";
                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <form class="forms-sample" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="row">
                                    <div class="col-md-6">
                                        <label for="exampleaddress">User_id<label style="color:Red">*</label></label>
                                        
                                            <input type="text" class="form-control" name="id" 
                                            value="">
                                        </div>
                                        <div class="col-md-6">
                                        <label for="exampleaddress">Name<label style="color:Red">*</label></label>
                                    ...
                                    <div class="row">
                                    <div class="col-md-6">
                                    <label for="examplepan">Password</label>
                                      ...
                                      <label for="examplepan">Photo<label
                                          ...
                                          <input type="file" name="upload_icon" value="">
                                        </div>
                                    </div>
